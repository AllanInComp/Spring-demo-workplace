...
public class AroundWithHandlingExceptionsDemoApp8 {
	
	private static Logger myLogger = Logger.getLogger(AroundWithHandlingExceptionsDemoApp8.class.getName());
